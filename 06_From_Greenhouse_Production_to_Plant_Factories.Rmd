...
Paper discussion: We will discuss the article “Wheat yield potential in controlled-environment vertical farms” by Asseng et al. (2020)(see [eCampus)](https://ecampus.uni-bonn.de/goto_ecampus_file_3510292_download.html). The article is not on a horticultural crop, but a good case study, which could be transferred to other crops, too. There are two tasks:
